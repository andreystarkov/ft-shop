...
$(document).ready(function() {
	...
	$('.product-thumb .image a').each(function(){

		if( $('img', this).attr('src') > 0 ){

		} else {
			console.log('olol');
			$('img', this).css({'height': '228px', 'width': '160px'});
		}
	});
...
*/
	...
	$('#grid-view').click(function() {
		...
		if (cols == 2) {
			...
			$('#content .product-layout').attr('class', 'product-layout product-grid col-lg-3 col-md-15 col-sm-4 col-xs-6');
		}
